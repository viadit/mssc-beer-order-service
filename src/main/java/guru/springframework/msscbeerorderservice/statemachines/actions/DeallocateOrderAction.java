...
import guru.springframework.brewery.model.events.DeallocateOrderRequest;
...
@Component
public class DeallocateOrderAction implements Action<BeerOrderStatusEnum, BeerOrderStatusEnum> {
